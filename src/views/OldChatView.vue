...
// import mainChat from "../components/chat/main.vue";
...
export default {
  name: "mainNav",
  components: { mainChat, peopleList },
  // setup() {
  ...
  methods: {
    ...
    setUsers(users) {
      console.log(users);
      this.$refs.peopleList.setUsers(users);
    },
    userJoined(user) {
      this.$refs.peopleList.addUser(user);
    },
    leftUser(user) {
      this.$refs.peopleList.removeUser(user);
    },
  },
};
</script>
